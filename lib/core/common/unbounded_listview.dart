...
//     }
//
//     if (effectivePadding != null) sliver = UnboundedSliverPadding(padding: effectivePadding, sliver: sliver);
...
//     geometry =
//         UnboundedSliverGeometry((existing: geometry)!, crossAxisSize: childGeometry.crossAxisSize + padding.vertical);
//   }
// }
//
...
//       }
//       unboundedSize =
//           math.max(unboundedSize, constraints.axis == Axis.horizontal ? child.size.height : child.size.width);
//     }
//
